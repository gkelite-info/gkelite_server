...
interface ApplicationAnalyticsLogAttributes {
    ...
    college?: string; // Nullable, college identifier
    path: string;
    ipAddress?: string;
    userAgent?: string;
    metadata?: object;
...
export interface ApplicationAnalyticsLogInput extends Optional<ApplicationAnalyticsLogAttributes, "logId" | "isActive" | "is_deleted" | "formType" | "applicationId" | "college" | "ipAddress" | "userAgent" | "metadata"> { }
